...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  OkHttpClient(Builder builder) {
	  System.out.println("MARAUDER: initializing new okhttp client\n");
    this.dispatcher = builder.dispatcher;
    this.marauder = builder.marauder;
    // this.dispatcher.marauder = this.marauder;  
    System.out.format("MARAUDER: adding custom interceptor\n");  
    builder.interceptors.add(new MarauderInterceptor(this.marauder));
    System.out.format("MARAUDER: finished adding custom interceptor\n");  
  ...
  @Override public Call newCall(Request request) {
	System.out.println("IN NEW CALL");
  ...
  public static final class Builder {
    ...
    Builder(OkHttpClient okHttpClient) {
      ...
      this.marauder = okHttpClient.marauder;
    ...
    void setInternalCache(@Nullable InternalCache internalCache) {
      ...
      this.cache = null;
      System.out.println("XXXXX SETTING INTERNAL CACHE");
    }
    ...
    public Builder cache(@Nullable Cache cache) {
      ...
      System.out.println("XXXX SETTING CACHE IN BUILDER");
      return this;
    }
